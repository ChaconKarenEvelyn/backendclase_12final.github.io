...
<html lang="en">
  ...
  <body>
    ...
    <section class="introduccion" id="introduccion-te">
      ...
      <a href="./agregar_producto.php" type="button" id="boton_agregar" class="btn btn-danger"> 
    ...
    <?php
      ...
      while($unafila = mysqli_fetch_assoc($resultado)){
        echo "<tr>";
        echo "<td>". $unafila["id_producto"]."</th>";
          ...
          <a href='./editar_producto.php?id=".$unafila["id_producto"]."' class='edit' title='Edit' data-toggle='tooltip'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil' viewBox='0 0 16 16'>
