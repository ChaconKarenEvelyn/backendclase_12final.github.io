...
"<div class='card border-dark mb-6' id='card_eliminar' style='max-width: 18rem;'>
...
<path d='M7.002 12a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 5.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0z'/>
  ...
  <div class='card-body'>
    <div class='alert alert success'>¡Se eliminó correctamente el producto!</div>
    <a href='./proyecto.php' class='card-text'><button type='button' class='btn btn-primary'>VOLVER</button> </a>
  </div>
</div>";
